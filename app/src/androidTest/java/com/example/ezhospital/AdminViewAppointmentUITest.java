...
public class AdminViewAppointmentUITest {
    ...
    @Test
    public void adminViewAppointmentUITest() {
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recycler_state),
                        childAtPosition(
                                withClassName(is("android.widget.RelativeLayout")),
                                1)));
        ...
        ViewInteraction recyclerView3 = onView(
                allOf(withId(R.id.recycler_floor),
                        childAtPosition(
                                withClassName(is("android.widget.RelativeLayout")),
                                1)));
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.edt_user),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText.perform(replaceText("aclinic_David"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.btn_login), withText("Authentication"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
