...
public class ViewAppointmentInCalendarUITest {
    ...
    @Test
    public void viewAppointmentInCalendarUITest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.etEmail), withText("6"),
                        childAtPosition(
                                allOf(withId(R.id.layout),
                                        childAtPosition(
                                                withClassName(is("android.widget.RelativeLayout")),
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("66@gmail.com"));
