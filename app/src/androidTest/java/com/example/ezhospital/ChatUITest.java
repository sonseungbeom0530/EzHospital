...
public class ChatUITest {
    ...
    public void chatUITest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.messageEt),
                        childAtPosition(
                                allOf(withId(R.id.chatLayout),
                                        childAtPosition(
                                                withClassName(is("android.widget.RelativeLayout")),
                                                2)),
                                0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.messageTv), withText("hello"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.timeTv), withText("21/10/2020 04:38 AM"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        0),
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("21/10/2020 04:38 AM")));
        ...
        ViewInteraction bottomNavigationItemView2 = onView(
                allOf(withId(R.id.nav_chat), withContentDescription("Chats"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.navigation),
                                        0),
