...
public class AdminAuthenticationDialog {
    ...
    public static AdminAuthenticationDialog mDialog;
    public IDialogClickListener iDialogClickListener;

    public static AdminAuthenticationDialog getInstance(){
        if (mDialog==null)
            mDialog=new AdminAuthenticationDialog();
        return mDialog;
    }

    public void showAuthenticationDialog(String title,
                                         String positiveText,
                                         String negativeText,
                                         Context context,
