...
import com.example.ezhospital.Fragment.AdminChatHomeFragment;
...
public class AdminChatDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft3.replace(R.id.content,fragment1,"");
        ft3.commit();
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch ((menuItem.getItemId())){
                        case R.id.nav_home:
                            ...
                            AdminChatHomeFragment fragment1 = new AdminChatHomeFragment();
